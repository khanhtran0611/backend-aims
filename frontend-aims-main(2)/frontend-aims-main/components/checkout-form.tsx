...
export default function CheckoutForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const rushItems = formData.orderLineList.filter((line) => line.rush_order_using)
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        checked={isRushOrder}
                        onCheckedChange={(checked) => updateOrderLine(item.product.product_id, "rush_order_using", checked)}
